...
export function VoiceOrb({ active = false }: VoiceOrbProps) {
  return (
    <div className="relative flex size-30 items-center justify-center sm:size-36 md:size-40">
      <motion.div
      ...
      <motion.div
        className="relative z-10 rounded-full bg-linear-to-b from-[#9d50bb] via-indigo-600 to-[#00d2ff] p-[3px] shadow-[0_0_52px_rgba(157,80,187,0.55),0_0_40px_rgba(0,210,255,0.35)]"
        animate={active ? { scale: [1, 1.03, 1] } : { scale: 1 }}
        transition={{ duration: 2.4, repeat: active ? Infinity : 0, ease: "easeInOut" }}
      >
        <div
          className="relative grid size-25 place-items-center overflow-hidden rounded-full sm:size-28 md:size-29"
          style={{
            background:
